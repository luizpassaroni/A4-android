...
public final class PedidosAtivosFragment extends Fragment {
    ...
    @Override public void onViewCreated(@NonNull View view, @Nullable Bundle state) {
        ...
        PedidoAtivoAdapter adapter = new PedidoAtivoAdapter(vm::avancarStatus);
        binding.listaAdmin.setLayoutManager(new LinearLayoutManager(requireContext()));
        binding.listaAdmin.setAdapter(adapter);
        vm.getPedidosAtivos().observe(getViewLifecycleOwner(), adapter::atualizar);
    }
